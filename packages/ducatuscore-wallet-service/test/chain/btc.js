...
const { DucatuscoreLib } = require('@ducatuscore/crypto');
...
describe('Chain BTC', function() {
  describe('#getDucatuscoreTx', function() {
    ...
    it('should create a valid signed ducatuscore TX', function() {
      ...
      // should serialized
      t.serialize().should.equal(
        ''
      );
    ...
    it('should create a valid unsigned ducatuscore TX', function() {
      ...
      (function() {
        return t.serialize();
      }.should.throw('not been fully signed'));

      t.uncheckedSerialize().should.equal(
        '0100000001c05c50d820b4cbb4432af783a0a0b81f50cbf7c890939e713a9f03fb01eb7f4e0500000000ffffffff0282233101000000001976a9149edd2399faccf4e57df08bef78962fa0228741cf88ac00b4c404000000001976a91451224bca38efcaa31d5340917c3f3f713b8b20e488ac00000000'
      );
  ...
  describe('#getEstimatedSize', function() {
    ...
    it('1  input p2pkh,  2 output p2pkh, 1 output p2sh  ', function() {
      ...
      tx.from(simpleUtxoWith1BTC)
        .to([
          { address: toAddress, satoshis: 1e7 },
          { address: toAddress, satoshis: 1e6 }
        ])
    ...
    const p2wshAddress = DucatuscoreLib.Address.createMultisig(
      ...
      'testnet',
      null,
      DucatuscoreLib.Address.PayToWitnessScriptHash
    );
...
var aTXP = function() {
  var txp = {
    ...
    proposalSignature:
      '7035022100896aeb8db75fec22fddb5facf791927a996eb3aee23ee6deaa15471ea46047de02204c0c33f42a9d3ff93d62738712a8c8a5ecd21b45393fdd144e7b01b5a186f1f9',
    changeAddress: {
      version: '1.0.0',
...
const signedTxp = {
  ...
  coin: 'bch',
  network: 'livenet',
  outputs: [{ amount: 80000000, toAddress: 'CPrtPWbp8cCftTQu5fzuLG5zPJNDHMMf8X' }],
  amount: 80000000,
  message: 'some message',
  changeAddress: {
    version: '1.0.0',
  ...
  customData: null,
  proposalSignature:
    '3045022100e8a1ac6eef882fb3e7311c725093317df99e5ed46f52fdee9064560bb757d1c902200b09f806a17d4c7950097b8714293725ce741c6de25914f81a8ca0ca1107fc4c',
  signingMethod: 'ecdsa',

...
The easiest and recommended way to use them, is via [Bower](http://bower.io/), a browser package manager, and get the release bundles. For example, when building an app that uses `@ducatuscore/lib` and `@ducatuscore/mnemonic`, you do:

```sh
bower install @ducatuscore/lib
bower install @ducatuscore/mnemonic
```
